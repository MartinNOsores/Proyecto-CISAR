...
def echo(update: Update, context: CallbackContext) -> None:
    ...
    def registrarNombreApellido(update: Update, context: CallbackContext) -> int:
        ...
        user = update.effective_user
        update.message.reply_text('Indique su nombre y apellido completo: ',reply_markup=ReplyKeyboardMarkup(reply_keyboard, one_time_keyboard=True),)
    ...
    def registrarDNI(update: Update, context: CallbackContext) -> int:
        ...
        update.message.reply_markdown_v2(
        f'Hola {user.mention_markdown_v2()}\! le solicito que me mande su DNI completo por escrito'
...
def main() -> None:
    ...
    dispatcher.add_handler(CommandHandler("Registrar", registrarNombreApellido))
